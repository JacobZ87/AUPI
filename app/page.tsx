...
function stampDuty(state: State, price: number): number {
  if (price <= 0) return 0;
  ...
  switch (state) {
    ...
    case 'VIC':
      ...
      return 109870 + (price - 2000000) * 0.065;
    case 'QLD':
...
export default function HomePage() {
  ...
  const result = useMemo(() => {
    ...
    const stamp = stampDuty(state, purchasePrice);
